[
  ...
  %{
    origin: "몽키 비즈니스(2001)",
    quotations: [
      "관리자란 개인적인 시간과 노력(또는 노동)을 직접 투입하기보다는 주로 자신들의 판단과 영향력을 통해 조직에 기여하는 사람들을 말한다.",
      "원숭이는 두 당사자의 대화가 끝났을 때 실행에 옮겨질 다음 행동을 의미한다. 원숭이는 문제나 프로젝트, 프로그램 또는 기회 따위가 아니다. 원숭이는 문제를 해결하거나 프로그램 또는 프로젝트를 진척시키기 위해, 또는 기회를 추구하기 위해 다음번에 이루어져야 할 주도적 행위, 행동을 뜻한다.",
      "당신의 부하들이 자유수준 척도 '(1) 지시가 있을 때까지 기다린다'와 '(2) 무엇을 할지 묻는다'에서 행동한다면 부하들로 인한 시간은 피할 길이 없다. 부하들이 생각하고 계획하고 문제를 푸는 것에 당신의 시간을 들여야만 된다는 뜻이다. 그것은 당신의 부하들로부터 요구되는 시간이다. 이로 인해 당신은 여유시간을 뺏기게 될 것이다.",
      "그런데 30분이 지난 후 당신은 조지에게 '생각해 보고 연락해 주겠네'라고 말했고 조지는 '좋습니다'라고 답했다. 그리고 당신들은 헤어졌다. 이제 원숭이는 누구의 등에 타고 있는가? 당신의 등이다!",
      "원숭이를 넘겨받음으로써 당신은 스스로 부하보다 낮은 지위로 내려간 셈이다. 조지가 당신 위에 군림하게 된 것은 부하가 상사를 위해서나 할 법한 일을 당신 스스로 자원하였기 때문이다. (1) 당신은 그로부터 책임을 넘겨받았으며 (2) 진척 상황을 보고하겠다고 약속했다.",
      "모든 원숭이는 두 종류의 일과 관련되어 있는데, 실행해야 할 일과 감독해야 할 일이 그것이다.",
      "나는 그에게 기업 PR에 관한 제안서를 만들어 보라고 지시하고는 필요한 사항을 지원하겠다고 약속한다. 회의를 마칠 때 나는 이렇게 말한다. '내가 도울 방도를 알려 주시오.' 이 상황에서도 처음 원숭이는 그녀의 등에 올라타 있다.",
      "문제를 지닌 부하가 관리자에게 말하는 올바른 화법은 '나에게 문제가 생겼습니다'라고 말하는 것이다. '우리에게 문제가 생겼습니다'라고 말하는 것은 주제넘은 표현이다. 왜냐? 그것은 자신이 상사의 입장에서 말하는 것이기 때문이다. 상사는 팀원 전체가 소속된 팀의 우두머리다. 그러므로 그가 인정하기 전까지는 어떤 문제도 '우리의' 문제가 아닌 것이다. 즉 상사가 '우리에게 문제가 생겼습니다'라고 말하기 전까지 문제는 단지 부하의 개별적인 문제일 뿐이다.",
      "관리자의 전략은 자기로 인한 시간 중에서 부하들에 의해 소진되는 부분('윗방향으로 이루어지는 업무 위양'을 뜻함)을 최소화함으로써 여유롭게 활용할 수 있는 시간을 증대시키는데 초점이 맞춰져야 한다. 이렇게 증대된 여유시간은 상사와 시스템이 요청하는 활동을 하는 데 투입될 수 있으므로 관리자는 그들의 능력에 대한 상사의 신임을 돈독하게 하고 동료들 및 지원그룹과 협조적인 관계를 구축할 수 있게 된다.",
      "나는 부하 마이크와 업무협의를 마치며 이렇게 말한다. '좋아. 그것에 관해 메모를 해서 보내 주게.' 이럴 경우 원숭이는 부하의 등에 얹혀 있다. 왜냐하면 다음 행동을 취해야 할 사람은 부하이기 때문이다. 그러나 그것은 내게로 뛰어오를 준비를 하고 있는 상태임을 명심해야 한다. 원숭이를 지켜보자. 마이크는 제시간에 메모를 작성하여 내게 이메일로 전송한다. 그러면 나는 그것을 컴퓨터의 메일박스에서 열어 읽게 될 것이다. 이제 누가 행동해야 하는가? 나다.",
      "물론 그것이 나의 원숭이일 수도 있다. [.] 그러나 이 경우에도 그것을 증명할 책임은 누구에게 있는가? 그에게 있다. 심지어 그가 그 원숭이가 나의 것임을 입증하는 동안에도 그놈은 그의 등에 찰싹 달라붙어 있어야 한다. 그 후에 나는 이성적이고 합리적인 태도로 그 원숭이를 집어서 내 등에 올려 놓으면 된다. 그러나 주인이 없다고 해서 원숭이를 내 등에 올려 놓는 일은 삼가야 한다.",
      "당신과 밥은 함께 부사장을 면담한다. 이 경우 원숭이는 어디에 있는가? 밥의 등이다! 부사장실에 들어갈 때 밥의 등에 올라타 있던 원숭이는 나올 때도 여전히 그 자리에 머물고 있는 것이다. 얼마나 많은 고위층 경영자들이 조직 내의 계층격차를 빌미로 부하들의 심부름을 하고 있는지 모른다. 이 경우에도 부하들은 여전히 이렇게 말한다. '어떻게 됐습니까?' '빨리 해야죠' '뭔가 결정을 내리시죠' 부하를 함께 동행하라. 이렇게 하는 것이 그에게는 훌륭한 경엉자 수업이 될 수도 있으며 무엇보다 원숭이가 엉뚱한 방향으로 뛰어오르는 일도 일어나지 않는다.",
      "당신이 그에게 메모를 요구한 행위는 지극히 사리에 맞는 일이었다. 서류화 작업이나 향후 일정 꾸미기 등은 당신의 기억을 새롭게 자극할 것이므로 나쁠 것이 없다. 그 부분은 괜찮다. 다만 '메모를 보내 주게'라고 말한 부분을 '메모를 들고 오게'라고 말했어야 한다."
    ]
  },
  %{
    origin: "The Little Elixir & OTP Guidebook",
    quotations: [
  ...
  %{
    origin: "창의성을 지휘하라 (Creativity, Inc.)",
    quotations: [
      "픽사 사장으로서 내 목표는 언제나 픽사가 창업자들보다 오래 생존할 수 있게 픽사에 계속 생명력을 불어넣는 창의적 기업문화를 구축하는 것이었다.",
  ...
  %{
    origin: "Modern C++ Design",
    quotations: [
      "시스템 아키텍처의 중요한 목적 중 하나는 특정 명제들을 'by design'에 의해 공리화시키는 것입니다. 예를 들면, 싱글톤 객체를 두 개 이상 만들어서는 안 됩니다. [.] 그리고 이러한 제약 조건들은 가능하면 컴파일 시에 걸러지도록 디자인되는 것이 이상적이라 할 수 있습니다.",
  ...
  %{
    origin: "대체 뭐가 문제야? (Are Your Lights On?)",
    quotations: [
      "어떤 질문을 던져야 할까? '누가' 문제를 안고 있는가? 그것은 어떤 문제인가? 혹은, 이 시점에서 도대체 뭐가 '문제'란 말인가?",
  ...
  %{
    origin: "Remote: Office Not Required",
    quotations: [
      ...
      "Would be remote workers and managers have a lot to learn from how the open origin: software movement has conquered the commercial giants over the past decades. It's a triumph of asynchronous collaboration and communication like few the world has ever seen.",
  ...
  %{
    origin: "설명 잘하는 법",
    quotations: [
      "곰곰이 생각해보면 직장은 물론이고 일상생활에서도 모든 것이 설명의 연속이다. 남에게 부탁을 하거나 자신의 행동을 이해하게 하려면 어쨌거나 설명을 해야한다.",
  ...
  %{
    origin: "페르시아의 왕자 : 조던 메크너의 게임 개발일지",
    quotations: [
      "일단 비디오카메라를 사서 가능한 한 최선의 영상을 찍어 (노이즈를 감수하고) 디지타이징할 것. 이걸 일단 예시로서 게임에 끼워 놓고 나머지 부분의 프로그래밍을 계속할 것. 그러다가 나중에 내가 원하는 것이 무엇인지가 좀 더 명확해지면 그때 실제로 사용할 영상을 '슈퍼 8'로 다시 찍으면 된다.",
  ...
  %{
    origin: "프로그래머의 길, 멘토에게 묻다",
    quotations: [
      "알지도 못하며 그 사실도 모르는 자, 바보로다. 그를 멀리하라! 알지 못하나 그 사실을 아는 자, 못 배운 자로다. 그를 가르치라! 알고 있으나 그 사실을 모르는 자, 잠든 자로다. 그를 깨우라! 알고 있으며 그 사실을 아는 자, 깨우친 자로다. 그를 따르라! - 아랍 속담",
  ...
  %{
    origin: "앱만장자(appillionaires)",
    quotations: [
      "하지만 앱은 이머징 산업이고, (대기업들이) '앱스토어에서 돈 벌기'라는 분야에 눈을 돌리기 시작해, 그 공식을 이해하고 (취미 프로그래머들을) 밀어내기 시작하는 시점이 올 겁니다. 대기업들은 다른 업체와 통합을 할 것이고, 자신의 방에서 일하는 프로그래머들은 돈을 벌기 위해 더 큰 회사에 합류해야 할지도 모릅니다.",
  ...
  %{
    origin: "패턴을 활용한 리팩토링",
    quotations: [
      "패턴은 프로그램 내에서 볼 수 있는 어떤 것이기도 하지만, 동시에 프로그램을 변환하는 것이기도 합니다. 각 패턴은 패턴 적용 전과 후의 모습으로 설명할 수 있습니다. 이는 패턴을 리팩터링으로 생각할 수 있는 또 다른 방법이기도 합니다. - Ralph Johnson",
  ...
  %{
    origin: "만화의 이해",
    quotations: [
      "카툰화법은 단순히 그림의 방법일 뿐만 아니라, 보는 방법입니다!",
  ...
  %{
    origin: "단순하게 말하라",
    quotations: [
      "단순한 대화는 배려를 바탕으로 한다. 자신이 말하는 것보다 상대가 어떻게 듣느냐가 대화의 결과를 좌우하기 때문이다. 따라서 자신이 원하는 것을 정확히 전달하기 위해서는 상대가 자신의 말을 어떻게 받아들일지 고려하는 과정이 필요하다."
    ]
  },
  %{
    origin: "만화의 미래",
    quotations: [
      "만약 필요가 발명의 어머니라면, 발명은 욕망의 어머니입니다.",
  ...
  %{
    origin: "바보상자의 역습",
    quotations: [
      "대중문화는 우리가 저질, 통속이라고 무시하는 연예물을 통해 지속적으로 아주 조금씩 우리 뇌를 명민하게 만들고 있다. 이런 상향 트랜드를 나는 슬리퍼 커브(Sleeper Curve)라고 이름 지었다. 슬리퍼 커브는 우디 앨런의 고전 공상과학 영화 <슬리퍼>에서 착안했다. 2173년 미래세계에서 과거로 온 과학자들이 크림 파이와 핫 퍼지를 다이어트의 적이라며 무시하는 20세기 인간을 보고 충격을 받는 장면처럼, 우리가 무시하는 대중문화가 정작 엄청난 가치를 지니고 있을지도 모른다.",
  ...
  %{
    origin: "생각의 탄생",
    quotations: [
      "직감과 직관, 사고 내부에서 본질이라고 할 수 있는 심상이 먼저 나타난다. 말이나 숫자는 이것의 표현수단에 불과하다. - 아인슈타인",
  ...
  %{
    origin: "학문의 즐거움",
    quotations: [
      "인간의 두뇌는 과거에 습득한 것의 극히 일부밖에 기억해 내지 못하게 되어 있다. 그런데 왜 사람은 고생해서 배우고, 지식을 얻으려고 하는가? 나는 '지혜'를 얻기 위해서라고 말하고 싶다. 배워 나가는 과정에서 지혜라고 하는, 눈에 보이지 않지만 살아가는 데 있어 매우 중요한 것이 만들어진다고 생각한다.",
  ...
  %{
    origin: "큐레이션",
    quotations: [
      "우리가 다룰 '큐레이션'이라는 용어 역시 그 의미가 빠르게 변화하고 있다. 본래 박물관이나 미술관에서 작품을 전시한다는 의미를 가진 큐레이션이라는 용어는 오늘날 어디에서나 통용되는 말이다. 영화제에서는 상영 프로그램을 큐레이트하고, 웹사이트는 게시글을 큐레이트한다. '큐레이션'은 한때 교양 있고 고급스러운 이미지를 가진, 평범한 서민과는 거리가 먼 단어였다.",
  ...
  %{
    origin: "소프트웨어 개발의 지혜",
    quotations: [
      "풍족한 세상에서, 점점 더 부족해지고 있는 유일한 것은 사람들의 주의력이다. - 와이어드(Wired)지에서, 캐빈 캘리(Kevin Kelly)",
  ...
  %{
    origin: "수학자, 컴퓨터를 만들다(The Universal Computer)",
    quotations: [
  ...
  %{
    origin: "xUnit 테스트 패턴",
    quotations: [
      "래즈베리 쨈의 법칙 : 넓게 바를수록 얇게 퍼진다. - 제리 와인버그 (Jerry Weinberg)",
      "모방은 상대방에 대한 최고의 찬사다.",
      "목욕물을 버리면서 아이까지 함께 버리지 말자.",
      "새 망치가 생기면 전부 못으로 보인다!"
    ]
  },
  %{origin: "코드 크래프트", quotations: ["편지가 길어서 죄송합니다. 짧게 쓸 시간이 없었습니다."]},
  %{
    origin: "미래를 만든 Geeks",
    quotations: [
  ...
  %{
    origin: "드리밍 인 코드",
    quotations: [
      "리팩토링은 종종 정원 관리에 비유되곤 한다. 즉 리팩토링 작업에 완료란 없다.",
      "호프스태터의 법칙 : 프로젝트는 당신의 예상보다 언제나 더 오래 걸릴 것입니다. 당신이 호프스태터의 법칙을 염두에 둔다 해도 말입니다."
    ]
  },
  %{
    origin: "소프트웨어 아키텍트가 알아야 할 97가지",
    quotations: [
      "만일 소통이 '왕'이라면 명확성과 리더쉽은 소통을 위해 반드시 수반되어야 하는 '신하'입니다.",
  ...
  %{origin: "WRITING SOLID CODE", quotations: ["버그는 절대로 '자살'하는 법이 없지."]},
  %{
    origin: "위대한 게임의 탄생",
    quotations: [
      "퀘스트의 핵심은 플레이어들이 금방 깰 수 있도록 길이가 적당하면서 보상도 받을 수 있는 임무를 제공하는 것입니다. '딱 하나만 더 해볼까'라는 느낌을 주고 싶었지요. - wow",
  ...
  %{
    origin: "사랑하지 않으면 떠나라",
    quotations: [
      "가장 못 하는 사람이 되려고 한다는 것, 이것은 실질적으로 자신에 대한 두려움으로부터 자유로워진다는 것이다. 이제는 자신을 무시하지 않게 한다. 사람들은 A급 밴드에 속할 수도 있지만 항상 B급 밴드에 들어간다. 두렵기 때문이다. 자신이 최고가 아니라는 것을 솔직히 인정하면 자신이 최고가 아니라는 사실이 알려지는 데 대한 두려움을 씻어 낼 수 있다. 사즉생의 역설같이 최악이 되려고 할 때 실제로는 최악이 되지 않을 것이다.",
  ...
  %{
    origin: "손에 잡히는 Vim",
    quotations: ["항상 과거를 돌아보라. 그러면 뭔가 배울 수 있을 것이다. - 폴 새뮤얼슨", "반복은 연구의 어머니다. - 쇼펜하우어, 문장론"]
  },
  %{
    origin: "Git, 분산 버전 관리 시스템",
    quotations: [
  ...
  %{
    origin: "도해사고력",
    quotations: [
      "항목별 메모는 기록한다는 느낌은 있지만 이해, 기억, 전달이라는 여러 측면에서 문제투성이다.",
  ...
  %{
    origin: "FREE 프리",
    quotations: [
      "이 새로운 형태의 '공짜'는 원자 경제가 아니라, 비트 경제를 토대로 하고 있다. 무엇인가가 일단 한 번 소프트웨어가 되면, 그 상품의 원가와 가격이 공짜가 되는 것은 디지털 시대의 독특한 특성이다. 그리고 이 새로운 형태의 공짜가 수십억 달러의 경제-즉 역사상 처음으로 기본가격이 0인 경제-를 창출하고 있다.",
  ...
  %{
    origin: "자연의 패턴",
    quotations: [
      "음표가 음악이 아니듯, 수학 기호도 그 자체는 수학이 아니다.",
  ...
  %{
    origin: "Programming Phoenix 1.4",
    quotations: [
      ...
      "Thanks to the Erlang VM, Elixir provides I/O concurrency without callbacks, with user-space multi-core concurrency. In a nutshell, this means Elixir developers write code in the simplest and most straight-forward fashion and the virtual machine takes care of using all of the reorigin:s, both CPU and I/O, for you.",
  ...
  %{
    origin: "창조적으로 이미지를 보는 법",
    quotations: ["문제는 당신이 무엇을 '보느냐(look)'가 아니라, 당신이 무엇을 '인식하느냐(see)'이다."]
  },
  %{
    origin: "Metaprogramming Elixir",
    quotations: [
  ...
  %{
    origin: "Designing Elixir Systems with OTP(2019)",
    quotations: [
  ...
  %{
    ...
    quotations: [
      "소프트웨어 개발 생태계는 일정한 동적 평형(dynamic equilibrium) 상태로 존재합니다. 즉, 어느 시점에서는 균형이 잡힌 상태이지만 장기적으로는 동적인 움직임을 나타냅니다. 이러한 생태계의 특성을 가장 잘 보여주는 예로, 요즘 대세인 컨테이너화(containerization)와 그로 인한 변화가 있습니다. ... 하나의 작은 변화가 또 다른 작은 변화를 일으키고, 그런 일이 수백 회 반복되면 또 다른 생태계가 새로 탄생합니다.",
      "아키텍트는 이전 시대에서 물려받은 가정과 공리에 의문을 제기할 중요한 책임이 있습니다. 소프트웨어 아키텍처를 주제로 한 책은 대부분 요즘 세상과는 거리가 먼 시대에 저술됐습니다. 사실 우리는 개선된 엔지니어링 프랙티스(engineering practice), 운영 생태계, 소프트웨어 개발 프로세스 관점에서 정기적으로 기본 공리에 의문을 가져야 한다고 믿습니다. 아키텍트와 개발자가 매일 작업하는 난잡한 동적 평형을 이루는 모든 것들에 대해서 말입니다.",
      "소프트웨어 아키텍트가 무엇을 하는 사람인가는 소프트웨어 아키텍처만큼이나 정의하기가 어렵고, 전문 프로그래머부터 회사의 전략적 기술 방향을 결정하는 것까지 매우 다양합니다. 그래서 우리는 정답도 없는 문제에 우왕좌왕하기 보다 사람들이 아키텍트에게 바라는 '기대치(expectations)'에 집중하고자 합니다. 아키텍처 결정을 내린다. 아키텍처를 지속적으로 분석한다. 최신 트렌드를 계속 유지한다. 아키텍처 결정의 컴플라이언스(compliance)를 보장한다. 다양한 기술과 경험에 노출된다. 비즈니스 도메인 지식을 보유한다. 대인 관계 기술이 뛰어나다. 정치를 이해하고 처세를 잘한다.",
      "컴플라이언스 보장이란, 아키텍트가 정의하고 문서화하여 전달한 아키텍처 결정과 설계 원칙들을 개발팀이 제대로 준수하고 있는지 지속적으로 확인한다는 뜻입니다.",
      "아키텍트는 개발팀을 기술적으로 이끌기만 하는 사람이 아니라, 개발팀을 리드해서 아키텍처를 구현하는 사람이므로 아키텍트라는 직책 또는 역할과 상관없이, 리더십 스킬은 소프트웨어 아키텍트로서 성공하기 위해 필수 요구사항의 절반 이상은 차지합니다. ... 우리는 기술적으로는 흠잡을 데 없이 우수하지만, 팀을 리드, 코치하고 개발자를 멘토링하면서 아키텍처 결정과 설계 원칙, 배경 사상을 효과적으로 전달할 능력이 결여된 소프트웨어 아키텍트를 벌써 여럿 만나봤습니다. 말할 나위도 없이 이런 사람들은 아키텍트 자리에 계속 앉아있기가 어렵습니다.",
      ...
      "'알려진 기지의 것들(known knowns)', 즉 우리가 알고 있다는 사실을 알고 있는 것들입니다. 그리고 '알려진 미지의 것들(known unknowns)', 즉 우리가 모르는 뭔가가 있다는 사실을 알고 있는 것입니다. 하지만 여기서 하나 더, '알려지지 않는 미지의 것들(unknown unknowns)'도 있습니다. 우리가 모른다는 사실조차 알지 못하는 것들이죠 - 도널드 럼즈펠드, 전 미국 국방부 장관",
      "모든 아키텍처는 알려지지 않은 미지의 것들 때문에 자꾸 되풀이되는데, 애자일은 단지 이것을 인지해서 더 빨리 수행하는 것이다. 그러므로 프로세스는 아키텍처와 거의 분리되어 있지만 소프트웨어 아키텍처의 속성상 반복적인 프로세스가 잘 맞습니다.",
      "소프트웨어 아키텍처의 모든 것은 다 트레이드오프다. - 소프트웨어 아키텍처 제1법칙",
      "아키텍트가 트레이드오프 아닌 뭔가를 발견했다고 생각한다면 그것은 그가 아직 트레이드오프를 발견하지 못했다는 증거일 가능성이 높다. - 제 1 정리",
      "'어떻게'보다 '왜'가 더 중요하다. - 소프트웨어 아키텍처 제2법칙",
      "아키텍트의 사고 방식은 크게 네 가지로 나뉩니다. 첫째, 아키텍처와 설계 차이를 이해하고 아키텍처 작업을 진행하려면 개발팀과 어떻게 협력해야 할지 아는 것입니다. 둘째, 어느 정도 기술 깊이를 유지하면서 폭넓은 기술 지식을 확보하는 것입니다. 그래서 아키텍트는 다른 사람들이 보지 못하는 해결책과 가능성을 떠올릴 수 있습니다. 셋째, 다양한 솔루션과 기술 간의 트레이드오프를 이해하고, 분석하고, 조율하는 것입니다. 넷째, 비즈니스 동인(business driver)의 중요성을 이해하고 그것을 아키텍처 관심사로 해석할 줄 아는 것입니다.",
      "여러분이 유능한 소프트웨어 아키텍트로서 병목 트랩에 안 빠지려면 먼저 크리티컬 패스와 프레임워크 코드는 다른 개발팀 사람에게 넘기고 비즈니스 기능을 코딩하는 작업에 집중해서 1~3회 이터레이션을 수행하는 것이 좋습니다. 이렇게 하면 세 가지 측면에서 긍정적인 효과가 있습니다. 첫째, 아키텍트는 더 이상 팀의 병목점이 되지 않고 프로덕션 코드를 실제로 작성하는 실무 경험을 쌓게 됩니다. 둘째, 크리티컬 패스와 프레임워크 코드를 개발팀에 분산시키고 소유권을 부여함으로써 시스템에서 가장 어려운 부분을 더 잘 이해할 수 있습니다. 셋째가 아마도 가장 중요한 장점인데, 아키텍트가 개발팀에서 작업 중인 비즈니스 연관 코드를 직접 작성함으로써 개발자들이 프로세스, 절차, 개발환경, 어느 부분에서 가장 큰 고통을 겪고 있는지 몸소 체험할 수 있습니다.",
      "PoC(Proof of Concept)를 자주 해보는 것입니다. PoC는 아키텍트가 소스 코드를 직접 작성해보면서 구현 상세를 생각하게 되므로 아키텍처 결정을 검증하는 데 유용합니다. 예를 들어, 두 가지 캐시 솔루션을 두고 갈팡질팡하고 있는 아키텍트가 결정 장애를 극복하는 가장 좋은 방법은, 실제로 각 제품을 응용한 예제 코드를 짜보고 실행 결과를 비교해보는 겁니다.",
      "응집(Cohesion)은 한 모듈의 파트가 동일한 모듈 안에 얼마나 포함되어 있는지를 나타냅니다. 다시 말해, 모듈을 구성하는 파트가 서로 얼마나 연관되어 있는가 하는 것입니다. 이상적으로 응집된 모듈이라면 모든 파트가 함께 패키징되어 있겠죠. 파트를 더 잘게 쪼개려면 모듈 간 호출을 통해 파트를 묶어야 유용한 결과를 얻을 수 있기 때문입니다.",
      "응집된 모듈을 나누려고 해봐야 더 커플링되고 가독성은 떨어진다. - 래리 콘스탄틴",
      "두 컴포넌트 중 한쪽이 변경될 경우 다른 쪽도 변경해야 전체 시스템의 정합성이 맞는다면 이들은 커네이선스(Connascence)를 갖고 있는 것이다. - 밀러 페이지-존스",
      "아키텍처에서는 틀린 답은 없고 값비싼 답만 있습니다!",
      "레이어드 아키텍처는 가장 흔한 아키텍처 스타일 중 하나입니다. 단순하고 대중적이면서 비용도 적게 들어 모든 애플리케이션의 사실상 표준(de facto standard) 아키텍처입니다. 시스템을 설계하는 조직은 그 조직의 소통 구조를 그대로 복제한 듯 설계할 수밖에 없다는 콘웨이의 법칙을 떠올려보면, 레이어드 아키텍처는 애플리케이션을 개발하는 아주 자연스러운 방법입니다. UI 개발자, 백엔드 개발자, 규칙 개발자, 데이터베이스 전문가(DBA)는 어느 회사건 다 있고 이런 조직의 계층 구조가 전통적인 레이어드 아키텍처와 잘 맞아떨어지니 많은 사랑을 받게 된 것입니다.",
      "레이어드 아키텍처는 (도메인 분할 아키텍처의 반대인) 기술 분할된 아키텍처입니다. 즉, 컴포넌트를 (고객 같은) 도메인 단위로 묶는 게 아니라, 아키텍처의 (프레젠테이션 또는 비즈니스 같은) 기술 역할에 따라 묶기 때문에 비즈니스 도메인이 각각 모든 아키텍처 레이어에 분산됩니다. 예를 들어, '고객' 도메인은 프레젠테이션, 비즈니스, 규칙, 서비스, 데이터베이스 모든 레이어에 다 포함되므로 이 도메인에 어떤 변경을 가하는 일이 쉽지 않습니다. 이런 이유로 이 아키텍처 스타일은 도메인 주도 설계 방식과는 잘 안 맞습니다.",
      "레이어드 아키텍처의 각 레이어는 폐쇄(closed) 또는 개방(open) 상태입니다. 폐쇄 레이어(closed layer)란, 요청이 상위 레이어에서 하위 레이어로 이동하므로 중간의 어떤 레이어도 건너뛸 수 없고 현재 레이어를 거쳐야 바로 그 다음 레이어로 나아갈 수 있다는 뜻입니다.",
      "레이어드 아키텍처에서는 아키텍처 싱크홀(architecture sinkhole) 안티패턴을 조심해야 합니다. 요청이 한 레이어에서 다른 레이어로 이동할 때 각 레이어가 아무 비즈니스 로직도 처리하지 않고 그냥 통과시키는 안티패턴을 말합니다.",
      "레이어드 아키텍처 기반의 애플리케이션은 규모가 커질수록 유지 보수성, 민첩성, 시험성, 배포성 같은 아키텍처 특성이 점점 나빠집니다. 따라서 레이어드 아키텍처를 사용한 대규모 애플리케이션이나 시스템은 다른 더 모듈러한 아키텍처 스타일이 더 잘 맞습니다.",
      "대부분의 개발자는 이 아키텍처를 Bash나 Zsh 같은 터미널 쉘 언어의 기초 원리임을 알고 있습니다. 함수형 언어 개발자는 언어 구조와 이 아키텍처 요소가 유사하다고 생각할 것입니다. 사실 맵리듀스(MapReduce) 프로그래밍 모델을 응용한 많은 도구가 이 기본 토폴로지를 따릅니다. 이처럼 파이프라인 아키텍처 스타일은 저수준에서 구현할 수도 있고 고수준의 비즈니스 애플리케이션에도 적용할 수 있습니다.",
      "마이크로커널 아키텍처 스타일은 코어 시스템(core system)과 플러그인 컴포넌트(plug-in component)라는 두 가지 아키텍처 요소로 구성된 비교적 단순한 모놀리식 아키텍처입니다. 애플리케이션 로직은 독립적인 플러그인 컴포넌트와 기본 코어 시스템에 골고루 분산되어 확장성, 적응성, 애플리케이션 기능 분리, 커스텀 처리 등을 수행합니다.",
      "이클립스 IDE, PMD, Jira, Jenkins 등 많은 소프트웨어 개발/릴리즈 도구가 마이크로 커널 아키텍처를 사용해서 개발됐습니다. Chrome, Firefox 같은 인터넷 웹 브라우저도 마이크로커널 아키텍처를 응용한 제품으로, 각종 뷰어와 플러그인을 장착하면 코어 시스템에 해당하는 기본 브라우저에 없는 부가 기능을 덧붙일 수 있습니다.",
      "서비스 기반 아키텍처(Service-based architecture)는 마이크로서비스 아키텍처 스타일의 일종으로, 아키텍처가 유연해서 가장 실용적인 아키텍처 스타일 중 하나입니다. 마이크로서비스나 이벤트 기반 아키텍처와 마찬가지로 분산 아키텍처지만 비교적 덜 복잡하고 비용이 많이 들지 않아서 많은 비즈니스 관련 애플리케이션에 널리 채택된 아키텍처입니다.",
      "서비스 기반 아키텍처는 중앙 공유 데이터베이스를 사용한다는 특징이 중요합니다. 따라서 서비스는 기존 모놀리식 레이어드 아키텍처와 동일한 방식으로 SQL 쿼리와 조인 기능을 사용하면 됩니다. 서비스 개수가 적어서 (4~12개) 데이터베이스 커넥션은 대개 문제가 안 되지만 데이터베이스 자체의 변경은 이슈가 될 수 있는데",
      "도메인 서비스는 세분도가 큰 까닭에 단일 도메인 서비스에서 데이터 무결성을 보장하기 위해 커밋/롤백이 수반되는 여느 ACID 데이터베이스 트랜잭션을 사용하지만, 마이크로서비스처럼 분산도가 높은 아키텍처는 서비스를 더 잘게 나누어 BASE 트랜잭션(기본적 가용성, 소프트 상태, 최종 일관성)이라고 알려진 분산 트랜잭션 기법을 사용합니다. 이 기법은 그 기반이 최종 일관성이므로 서비스 기반 아키텍처의 ACID 트랜잭션 레벨의 데이터 무결성을 지원하지 않습니다.",
      "공간 기반 아키텍처 스타일은 높은 확장성, 탄련성, 동시성 및 이와 관련된 문제를 해결하기 위해 설계된 아키텍처 스타일입니다. 동시 유저 수가 매우 가변적이라서 예측조차 곤란한 애플리케이션에서도 유용합니다. 극단적이고 가변적인 확장성 문제는 데이터베이스를 확장하거나, 확장성이 떨어지는 아키텍처에 맞게 캐시 기술을 적용하는 것보다 아키텍처적으로 해결하는 것이 더 낫습니다.",
      "프로그래머 앤드류 케이니그는 안티패턴이란 처음에는 좋은 생각처럼 보이지만 이내 곧 곤경에 빠뜨리는 애물단지라고 정의합니다. 부정적인 결과를 내는 반복 가능한 프로세스라고 정의하는 이들도 있습니다.",
      "이런 활동을 하는 아키텍트의 역할에 의문을 제기하고 팀을 효과적으로 만드는 책임을 PM이나 개발 관리자에게 일임하는 사람도 있습니다. 우리는 강력히 반대합니다. 소프트웨어 아키텍트는 팀을 기술적으로 이끌 뿐만 아니라, 아키텍처 구현을 통해 팀을 리드하기도 합니다. 소프트웨어 아키텍트는 개발팀과 긴밀한 협력 관계를 유지하면서 팀 역학을 관찰하고 변경을 촉진하여 효과적으로 팀을 움직일 수 있습니다. 이것이 바로 기술만 가진 아키텍트와 유능한 소프트웨어 아키텍트를 구분하는 잣대이기도 합니다.",
      "증명(demonstration)은 언제나 논쟁(discussion)을 이긴다는 사실을 명심하세요.",
      "소프트웨어 아키텍트는 개발팀을 이끌고 아키텍처를 구현하는 리더입니다. 유능한 소프트웨어 아키텍트가 되는 50% 정도는 효과적인 대인 관계 스킬, 조정 능력, 리더십에 있다고 생각합니다.",
  ...
  %{
    origin: "프로그래머의 뇌 (펠리너 헤르만스, 2022)",
    quotations: [
      "프로그래밍을 처음 배울 때는 코드를 만들어내는 것에 관심을 많이 갖는다. 대학이나 직장, 혹은 부트캠프에서도 일단 프로그래밍을 배우고 나면 코드를 작성하는 것에 훨씬 더 많은 관심과 시간을 쏟는다. 문제를 어떻게 풀고 그것을 코드로 어떻게 구현하는지를 집중적으로 훈련한다. 코드를 읽는 연습은 거의 전무할 것이다.",
      "코드에 있는 정보를 모두 STM(short-term memory)에 저장하고 처리하는 것은 물리적으로 불가능하다. STM은 읽거나 들은 정보를 짧은 시간만 저장한다. 여기서 짧은 시간이라는 것은 정말로 짧은 시간을 의미하는데 연구에 의하면 30초를 넘지 않는다. 30초 후에 그 정보는 LTM(long-term memory)에 저장되거나 잊힌다.",
      "좀 더 최근의 연구에서는 STM(short-term memory)의 용량이 2개에서 6개 사이로 심지어 더 적다고 추정한다. 이 용량은 거의 대부분의 사람에게 해당하고, 과학자들은 STM의 용량을 향상하는 방법을 아직 찾지 못했다. 기억 공간이 채 1바이트도 되지 않는 인간이 그 많은 일을 한다니 기적 아닐까?",
      "반면 전문가 그룹은 첫 번째 실험에서 다른 전략을 보였다. 이 그룹의 전문 체스 선수들은 LTM(long-term memory)에 저장되어 있는 지식을 많이 활용했다. 예를 들면 '시실리언 오프닝이고, 거기서 나이트 하나는 2칸 왼쪽' 같은 식이었다. 이런 방식으로 말의 위치를 기억하는 것은 시실리언 오프닝에서 어떤 말이 사용되는지에 대한 지식이 LTM에 있어야만 가능하다. 전문가 그룹이 하는 방식으로 말의 위치를 기억하는 것은 작업 기억 공간에서 4개 정도의 항목만 필요하다. STM(short-term memory)의 용량은 2개에서 6개 사이로 추정되기 때문에 4개 항목은 STM에 저장되는 게 가능하다.",
      "더흐로트는 몇 개의 그룹으로 묶은 정보를 청크(chunk)라고 불렀다. 예를 들어 '시실리언 오프닝'은 하나의 청크이므로 STM(short-term memory)의 기억 공간 하나만을 차지한다.",
      "'이 함수는 주어진 이진 트리를 중위 순회하여 프린트한다' 같은 고수준 주석문은 청크 단위를 쪼개는 데 도움이 된다. 반면 i++; 다음에 'i를 1만큼 증가' 같은 저수준 주석문을 넣는 것은 오히려 청킹 작업에 부담이 된다.",
      "의도적 연습(deliberate practice)은 어떤 기술을 향상하기 위해 조금씩 연습하는 것을 의미한다. 팔의 근육을 늘리기 위해 하는 푸시업은 의도적 연습이다. 음계(스케일) 연습 또한 음악가에게는 의도적 연습이다. 단어의 스펠링 연습하는 것도 처음 책을 읽는 아이에게는 의도적 연습이다. 프로그래밍에서는 여러 가지 이유로 의도적 연습이 흔치는 않다. 많은 사람이 코드를 많이 작성해보는 것으로 프로그래밍을 학습한다. 그렇게 해도 되지만 효과적인 방법은 아닐 수도 있다. 청킹을 의도적으로 연습하기 위해서는 적극적으로 코드를 기억해내는 것을 훈련하면 아주 좋다.",
      "로그래밍 문법에 대한 지식을 갖는 것에 대해 대수롭지 않게 생각할 수도 있다. 모르면 결국 온라인에서 찾아보면 되니 말이다. ... 코드를 효율적으로 이해하는 정도는 이미 알고 있는 지식에 의해 영향을 받는다. 따라서 프로그래밍 언어의 문법, 개넘과 자료구조를 외우면 코드를 더 빨리 파악하는 데 도움이 된다.",
      "프로그래밍 언어 문법을 포함해서 무엇이든 신속하게 학습할 수 있는 좋은 방법 중 하나가 플래시카드(flashcard)를 사용하는 것이다. 플래시카드는 종이 카드나 포스트잇으로 간단히 만들 수 있다. 앞면에는 암기하거나 학습하려고 하는 내용에 대한 프롬프트, 즉 그것을 지칭하는 단어나 질문이 있고 뒷면에는 그에 대한 내용이나 답이 있다.",
      "오랫동안 학습한 만큼 더 오래 기억한다. 이것은 더 많은 시간을 학습해야 한다는 것을 의미하는 게 아니라 더 오랜 간격을 두고 학습해야 한다는 것을 의미한다. 플래시카드를 한 달에 한 번 다시 학습하면 오랫동안 기억하는 데 충분하고, 이 정도는 충분히 할 수 있을 것이다. 이것은 정규 교육기간에서 한 학기 동안 혹은 부트캠프에서 3달 동안 배운 모든 지식을 머릿속에 집어넣어야 하는 경우와 극명하게 대비된다. 그렇게 학습한 지식은 그 이후로도 계속 반복해야만 잊어버리지 않는다.",
      "기억을 강화하는 두 가지 테크닉에 대해서 다룰텐데 적극적으로 무언가를 일부러 기억해보려고 애쓰는 인출(retrieval) 연습과 기존 기억에 새로운 지식을 적극적으로 연결시키는 정교화(elaboration)다.",
      "망각 곡선과 인출 강도의 효과에 대해 살펴봤기 때문에 매번 필요할 때마다 문법을 찾아보기만 하는 것이 왜 좋은 방법이 아닌지 분명해졌을 것이다. 너무 쉽게 정보를 찾고 또 그것이 너무 일상적으로 이뤄지다 보니 우리 두뇌는 문법을 기억할 필요가 없다고 느낀다. 따라서 프로그래밍 문법에 대한 인출 강도가 강화되지 않고 계속 약한 상태로 남아 있게 된다.",
      "우리 두뇌에서 기억은 다른 기억과 사실에 연결되는 연관된 네트워크의 형태라는 것을 살펴봤다. 사고나 생각이 서로 관련되어 조직된 방식을 스키마(schema) 혹은 스키마타(schemata)라고 부른다. 새로운 정보를 학습할 때 정보는 LTM(long-term memory)에 저장하기 전에 먼저 스키마의 형태로 만들어진다. 이미 존재하는 스키마에 잘 맞는 정보일수록 더 쉽게 기억할 수 있다.",
      "기억이 처음 저장될 때 기억의 부호화를 강화할 수 있는 한 가지 방법이 바로 정교화(elaboration)다. 정교화는 기억하고자 하는 내용을 기존 기억과 연관 지으면서 생각하는 것을 뜻하고, 이렇게 한 결과 LTM(long-term memory)에 이미 저장되어 있는 스키마타에 맞춰서 새로운 기억이 저장된다.",
      "사야니에미에 따르면 우리는 '변수'나 '정수'처럼 너무 많은 것을 포함하는 청크를 사용하거나 혹은 number_of_customer 같은 너무 구체적인 변수명처럼 너무 적은 것을 포함하는 청크를 사용하는 경향이 있다고 한다. 프로그래머는 그 사이의 중간이 필요한데, 이것이 사야니에미로 하여금 변수 역할(role of variables)이라는 프레임워크를 만든 동기가 됐다. 변수의 역할은 프로그램 내에서 변수가 하고자 하는 바를 나타낸다.",
      "문제 자체에 있는 내재적 부하와 문제의 표현이 초래하는 외재적 부하를 다뤘다. 하지만 앞에서 살펴보지 못한 세 번째 유형의 인지 부하가 바로 본유적(germane) 인지 부하다. 본유적 부하는 두뇌가 정보를 LTM에 다시 저장하기 위해 수행하는 노력을 의미한다. 여러분이 가지고 있는 모든 인지 부하가 내재적 부하와 외재적 부하로 가득 차면, 본유적 부하를 위한 여지는 남아 있지 않게 된다. 즉 문제와 그 해결책을 기억할 수 없다. 힘든 코딩 작업을 마친 후 때때로 자신이 한 일을 기억하지 못하는 경우가 있을 것이다. 이것이 바로 이런 이유 때문이다. 두뇌가 해결책을 저장할 수 없을 정도로 몰입해 있었던 것이다.",
      "주석문의 배후에 놓인 전반적인 아이디어는 설계자의 마음속에는 있었지만 코드로 표현할 수 없었던 정보를 포착하는 것이다. - 존 오스터하우트",
      ...
      "인지 과정에 대해 지금 필자가 알고 있는 것을 알기 전에는, 복잡한 논문을 읽거나 낯선 코드를 탐구할 만큼 똑똑하지 못한 것에 대해 자신에게 화가 나곤 했다. 이제 필자는 자신에게 더 관대하게 '음, 어쩌면 뇌가 너무 큰 인지 부하를 겪고 있나 봐'라고 말할 수 있다."
    ]
  }
]
